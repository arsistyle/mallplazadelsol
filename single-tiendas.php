          ...
          <div class="row contenido-dinamico">
              <div class="col-xs-12 col-md-6">
                <?php
                  ...
                  $imageFull = crop_image($image[0], $image[1],$image[2], true);
                  $imageSmall = crop_image($image[0], $image[1]*0.02,$image[2]*0.02, true);
                ?>
                <div class="tiendas__image">
                  <img src="<?php echo $imageSmall; ?>" data-src="<?php echo $imageFull; ?>" alt="" class="lozad">
                </div>
              ...
              <div class="col-xs-12 col-md-6">
                <?php
                  ...
                  if (get_field('tienda_sitio_web')) echo '<p><strong>Sitio web</strong>: <a href="'.get_field('tienda_sitio_web').'" class="link-externo" target="_blank">'.get_field('tienda_sitio_web').'</a></p>';
                  if (get_field('tienda_telefono')) echo '<p><strong>Teléfono</strong>: '.get_field('tienda_telefono').'</p>';
                ?>
                
                <?php
                  
                  $redes = array_filter(get_field('tienda_redes_sociales'));
                  if (count($redes)) {
