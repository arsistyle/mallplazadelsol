                ...
                ?>
                        <div class="tiendas__redes">
                          ...
                          <?php if($redes['facebook']) { ?>
                            <a href="<?php echo $redes['facebook']; ?>" target="_blank" class="tiendas__redes__link">
                          ...
                          <?php } ?>
                          <?php if(in_array('instagram', $redes)) { ?>
                            <a href="<?php echo $redes['instagram']; ?>" target="_blank" class="tiendas__redes__link">
                          ...
                          <?php } ?>
                          <?php if(in_array('twitter', $redes)) { ?>
                            <a href="<?php echo $redes['twitter']; ?>" target="_blank" class="tiendas__redes__link">
                          ...
                          <?php } ?>
                          <?php if(in_array('youtube', $redes)) { ?>
                            <a href="<?php echo $redes['youtube']; ?>" target="_blank" class="tiendas__redes__link">
